자기소개가 끝난 직후 이어지는 스몰토크(Small Talk)는 철저히 대비된 DFS(자기소개)에서 예측 불가능한 BFS로 넘어가는 단계입니다. 여기서 가장 중요한 원칙은 '내가 말을 많이 하려는 압박감을 버리고, 상대방이 말하게 만드는 것'입니다.

현실적이고 바로 써먹을 수 있는 3가지 스몰토크 전략과 치트키 문장들을 제안해 드립니다.

# 1. 'Newcomer' 카드 활용하기 (정보 묻기)
...
- "Yeah, transitioning back to academia is a big shift, but I'm excited." (내 대답) + "How about you? How long have you been in this lab?" (역질문)
